...
variables_in = ('c2h6','hcho','ch4','co','hno3','h5h8','no2','go3','pan','so2','aermr01','aermr02','aermr03','aermr04','aermr05','aermr06','aermr08','aermr10','aermr11','lnsp') #set variable name as defined in CAMS
variables_out = ('C2H6','CH20','CH4','CO','HNO3','ISOP','NO2','O3','PAN','SO2','SS1','SS2','SS3','DUST1','DUST2','DUST3','OM','BC','SO4','PSFC') #set variable name as required by CHIMERE
