...
source_clim = '/mnt/lustre/scratch//home/cesga/orballo/OP/DATOS/CICC/chimere2016a/chimere_bigfiles_2016a/MACC/clim'
outpath = '/mnt/lustre/scratch//home/cesga/orballo/OP/DATOS/CICC/chimere2016a/chimere_bigfiles_2016a/MACC/myclim_regional'
...
for ii in xrange(len(variables)):
    ...
    lons = lons.values    
    lons_ind_west = np.where(lons < 0)
    lons_ind_east = np.where(lons >= 0)
    ...
    for mm in xrange(len(months)):      
        ...
        lons_ind_west_clim = np.where(lons_clim < 0)
        lons_ind_east_clim = np.where(lons_clim >= 0)
