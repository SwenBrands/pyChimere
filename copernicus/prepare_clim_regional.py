...
tardate='20180606' #tested for global CAMS files only!
tarhour='00'
...
source_clim = lustre+'/OP/DATOS/CICC/chimere2017r4/MACC/clim_global'
outpath = lustre+'/OP/DATOS/CICC/chimere2017r4/MACC/myclim_regional'
    ...
    for mm in xrange(len(months)):      
        ...
        for tt in xrange(len(time_clim)):
            for ll in xrange(len(levs_clim)):
                data_out[tt,ll,:,:] = basemap.interp(data_clim[tt,ll,:,:], lons_aux_clim, lats_clim, lons_mesh, lats_mesh)
