...
variables = ['NO2','O3','PM10','PM25','SO2']
...
xlabel = ['CS10', 'CM10', 'CS20', 'CM20', 'FS10', 'FM10', 'FS20', 'FM20', 'AFM10SD', 'AFM20SD', 'AFM20CM', 'AFM20NBE', 'CS20EM', 'CM20EM', 'FS20EM', 'FM20EM'] #CM = "coarse meteorology, NBE = no biogenic emissions"
...
titlesize = 5
labelsize = 4
biastype = 'absolute' #absolute or percent
...
src_dirs = [lustre+'/SWEN/DATA/OBSDATA', RESpath+'/jja_13_gal15r/validation', RESpath+'/jja_10_gal15r/validation', RESpath+'/jja_12_gal15r/validation', \
            RESpath+'/jja_02_gal15r/validation', RESpath+'/jja_13/validation', RESpath+'/jja_10/validation', RESpath+'/jja_12/validation', \
            RESpath+'/jja_08/validation', RESpath+'/jja_11/validation', RESpath+'/jja_09/validation', RESpath+'/jja_14/validation', RESpath+'/jja_15/validation', \
            RESpath+'/jja_22/validation', RESpath+'/jja_21/validation', RESpath+'/jja_18/validation', RESpath+'/jja_17/validation']
...
execfile("metadata_rev1_reduced.py")
