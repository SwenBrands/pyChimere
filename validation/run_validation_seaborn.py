...
variables = ['NO2','O3','PM10','PM25']
xlabel = ['FS10', 'FM10', 'FS20', 'FM20', 'mx3', '6', '6corr', 'TR']
...
src_dirs = [lustre+'/SWEN/DATA/OBSDATA', RESpath+'/jja_13/validation', RESpath+'/jja_10/validation', RESpath+'/jja_12/validation', RESpath+'/jja_08/validation', RESpath+'/jja_05/validation', RESpath+'/jja_06/validation', RESpath+'/jja_06_corr_gal3/validation', lustre+'/SWEN/DATA/MODELDATA']
